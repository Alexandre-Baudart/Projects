...
def display_conf_matrix(cm, mode: Literal["clf_binary", "clf_multiclass", "clf_multilabel"] = "clf_binary", class_names: list | None = None, save_cm: bool = False, save_root: str = "./") :
